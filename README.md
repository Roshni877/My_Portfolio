...
- **Local Development**: Open `index.html` in any web browser or use `npx serve`.

## 📁 Repository Structure
- `index.html` — Main portfolio landing page
- `resume.pdf` & `Roshni_resume.pdf` — Resume documents
- `Roshni_Portfolio/assets/` — Certificates, project screenshots, and photos
- `Roshni_Portfolio/frames/` — Frame-by-frame animation sequences
